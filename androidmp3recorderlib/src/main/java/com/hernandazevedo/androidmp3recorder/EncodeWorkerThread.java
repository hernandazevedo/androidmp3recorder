...
public class EncodeWorkerThread extends HandlerThread implements AudioRecord.OnRecordPositionUpdateListener {
	private final AndroidLameEncoder lame;
	...
	private static class StopHandler extends Handler {
		...
		private EncodeWorkerThread encodeThread;
		
		public StopHandler(Looper looper, EncodeWorkerThread encodeThread) {
			super(looper);
	...
	public EncodeWorkerThread(File file, int bufferSize, AndroidLameEncoder lame) throws FileNotFoundException {
